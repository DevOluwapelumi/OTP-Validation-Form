...
document.getElementById("otpForm").addEventListener("submit", function(event) {
    ...
    var otp = document.getElementById("otpInput").value; // Get entered OTP
  
    // Validate OTP (Example: comparing it with "123456")
    if (otp === "123456") {
      document.getElementById("result").innerHTML = "<div class='alert alert-success'>OTP is valid!</div>";
    } else {
      document.getElementById("result").innerHTML = "<div class='alert alert-danger'>Invalid OTP!</div>";
    }
  });